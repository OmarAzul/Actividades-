/******************************************************************************
Alumno: Brandon omar Jacobo Morales
Fecha: 19 de Abril de 2025
Programa en C++ que realiza el calculo del RFC de acuerdo al SAT
*******************************************************************************/
#include <iostream>
#include <string>
...
// FunciC3n para obtener la primera vocal interna del apellido paterno
...
void corregirPalabraProhibida(std::string& rfc, const std::unordered_set<std::string>& palabrasProhibidas) {
	...
	if (palabrasProhibidas.count(primeras4)) {
		rfc[3] = 'X';  // Cambia la C:ltima letra por 'X'
	}
}

// FunciC3n para calcular RFC
